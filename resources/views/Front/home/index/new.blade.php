<div class="container-xxl py-3 mt-5">
    <div class="d-flex justify-content-between align-items-center border-bottom py-2 mb-3">
        <a href="{{ route('estates', ['n' => 1]) }}" class="d-block h3 mb-0 link-danger">@lang('app.news')</a>
        <a href="{{ route('estates', ['n' => 1]) }}" class="d-block"><i class="bi bi-chevron-right"></i></a>
    </div>
        <div class="row row-cols-2 row-cols-lg-4 row-cols-xl-4 g-3">
            @foreach($new as $estate)
